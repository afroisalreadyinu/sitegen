...
class SectionTests(unittest.TestCase, CollectionTestBase):
    ...
    def test_get_context(self):
        ...
        section.append_content_file(
            self.make_content_file("blog", "the-entry", "The Entry", date=high_date)
        )
        section.append_content_file(
            self.make_content_file("blog", "other-entry", "Other Entry")
        )
        ...
        assert context["site_info"] == SiteInfo(
            site_name="HELLO", base_url="http://bb.com", section="blog"
        )

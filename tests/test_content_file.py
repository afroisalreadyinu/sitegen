...
The content is this""",
    ...
    def test_get_template_section_single(self):
        ...
        templates = FakeTemplates(
            [FakeTemplate("single.html"), FakeTemplate("blog/single.html")]
        )
        template = cf.get_template(templates)
    ...
    def test_description(self):
        filepath = str(
            self.make_content_file(
                "content.md",
                """description: The index page is full of content
...
The content is this""",
    ...
    def test_context_empty_section(self):
        ...
        assert context["site_info"] == SiteInfo(
            site_name="HELLO", base_url="http://bb.com", section=""
        )
...
The content is this""",
    ...
    def test_draft_directory(self):
        filepath = str(
            self.make_content_file(
                "content.md", """The content is this""", dir_name="draft"
            )
        )
        cf = ContentFile("blog", "the-entry.md", filepath)
        assert cf.is_draft
